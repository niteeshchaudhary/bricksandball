 ...
 * @author NKC
 */
public class DBall extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        board.add(bat);
        bat.setBounds(360, 380, 120, 20);

        br.setBackground(new java.awt.Color(255, 102, 102));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(board, javax.swing.GroupLayout.PREFERRED_SIZE, 702, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(board, javax.swing.GroupLayout.PREFERRED_SIZE, 411, Short.MAX_VALUE)
        );
...
int n1= 0,n2=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DBall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void run() {
        for(;r1.getY()<=board.getHeight()+10;)
        {
            ...
            try {
                ...
                Logger.getLogger(DBall.class.getName()).log(Level.SEVERE, null, ex);
            }
            boardHit();
            brkHt();
...
int h=0,v=0,bs;
    private void brkHt() {     
        ...
        int result[]=result=br.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br.getX(),br.getY(),br.getWidth(),br.getHeight());        
        ...
        result=br2.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br2.getX(),br2.getY(),br2.getWidth(),br2.getHeight());        
        if(result[0]==1)
        {
        ...
        result=br3.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br3.getX(),br3.getY(),br3.getWidth(),br3.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
         ...
         result=br4.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br4.getX(),br4.getY(),br4.getWidth(),br4.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
        ...
        result=br5.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br5.getX(),br5.getY(),br5.getWidth(),br5.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
        ...
        result=br6.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br6.getX(),br6.getY(),br6.getWidth(),br4.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
        ...
        result=br7.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br7.getX(),br7.getY(),br7.getWidth(),br4.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
        ...
        result=br8.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br8.getX(),br8.getY(),br8.getWidth(),br4.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
        ...
        result=br9.hitchk(r1.getX(),r1.getY(),r1.getWidth(),r1.getHeight(),h,v,br9.getX(),br9.getY(),br9.getWidth(),br4.getHeight());        
        if(result[0]==1)
        {
            i=i*result[1];
            j=j*result[2];  
       ...
       //left side
       /* if(b1.isVisible() && i>0 &&b1.getX()<=(r1.getX()+r1.getWidth()+2) && b1.getX()>=(r1.getX()+r1.getWidth()) && (b1.getY()+b1.getHeight())>=r1.getY() && b1.getY()<=r1.getY())
        {
            b1.setBounds((int)(Math.random()*400), (int)(Math.random()*200), 80, 80);
            i=-i;
        }
        //right side
        if(b1.isVisible() && i<0 &&(b1.getX()+b1.getWidth()-1)<=(r1.getX()) && (b1.getX()+b1.getWidth()+3)>=(r1.getX()) &&(b1.getY()+b1.getHeight())>=r1.getY() && b1.getY()<=r1.getY())
        {
           b1.setBounds((int)(Math.random()*400), (int)(Math.random()*200), 80, 80);
            i=-i;
        }
        //up
        if(b1.isVisible() && j>0 &&b1.getX()<=(r1.getX()+r1.getWidth()+2) && (b1.getX()+b1.getWidth()-1)<=(r1.getX()) && (b1.getY()+2)>=r1.getY() && b1.getY()<=r1.getY())
        {
            b1.setBounds((int)(Math.random()*400), (int)(Math.random()*200), 80, 80);
            i=-i;
        }*/
